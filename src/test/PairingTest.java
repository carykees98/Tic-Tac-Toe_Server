...
//        assertNotNull(response_u4);
    ...
    */
     ...
     */
    @Test
    void testUpdatePairingWithUser2(){
        PairingResponse pairingResponse = sendUpdatePairingRequestWithUser("user2");
     ...
     */
    @Test
    void testDeclineInvitationWithUser2() {
        // Test 13
        // Send a DECLINE_INVITATION with user2 of the invitation above.
        // It should return a SUCCESS response.
        PairingResponse pairingResponse = sendDeclineInvitationRequestWithUser("user2");
        assertNotNull(pairingResponse);
        assertEquals(ResponseStatus.SUCCESS, pairingResponse.getStatus());
    }
    /*
     ...
     */
    @Test
    void testAcknowledgeInvitationWithUser1() {
        // Test 15
        // Send an ACKNOWLEDGE_INVITATION request with user1.
        // It should return a SUCCESS response.
        PairingResponse pairingResponse = sendAcknowledgeInvitationRequestWithUser("user1");
        assertNotNull(pairingResponse);
        assertEquals(ResponseStatus.SUCCESS, pairingResponse.getStatus());
    }
    /*
     ...
     */
    @Test
    void testSendInvitationFromUser1ToUser3() {
        // Test 16
        // Send a SEND_INVITATION from user1 to user3.
        // It should return a SUCCESS response.
        PairingResponse pairingResponse = sendSendInvitationRequest("user1", "user3");
        assertNotNull(pairingResponse);
        assertEquals(ResponseStatus.SUCCESS, pairingResponse.getStatus());
    }
     ...
     */
    @Test
    void testAcceptedInvitationWithUser3() {
        // Test 18
        // Send an ACCEPTED_INVITATION with user3 of the invitation above.
        // It should return a SUCCESS response.
        PairingResponse pairingResponse = sendAcceptedInvitationRequestWithUser("user3");
        assertNotNull(pairingResponse);
        assertEquals(ResponseStatus.SUCCESS, pairingResponse.getStatus());
    }
     ...
     */
    @Test
    void testUpdatePairingWithUser1AfterAcceptance() {
        // Test 19
        // Send a UPDATE_PAIRING request with user1.
        // It should return PairingResponspackage test;
        //
        //import org.junit.BeforeClass;
        //import org.junit.Test;
        //import static org.junit.Assert.*;
        ...
        //        // Test 19
        //        // Send a UPDATE_PAIRING request with user1.
        //        // It should return PairingResponse with an accept invitation response from user3.
        //        PairingResponse pairingResponse = sendUpdatePairingRequestWithUser("user1");
        //        assertNotNull(pairingResponse);
        //        assertNotNull(pairingResponse.getInvitationResponse());
        //    }
        ...
        //     */
        //    @Test
        //    void testAcknowledgeInvitationWithUser1AfterAcceptance() {
        //        // Test 20
        //        // Send an ACKNOWLEDGE_INVITATION request with user1.
        //        // It should return a SUCCESS response.
        //        PairingResponse pairingResponse = sendAcknowledgeInvitationRequestWithUser("user1");
        ...
        //     */
        //    @Test
        //    void testUpdatePairingWithUser2AfterGameStart() {
        //        // Test 21
        ...
        //        assertEquals("user4", pairingResponse.getAvailableUsers().get(0).getUsername());
        //    }
        //    /*
        //     * Test 22. Send an ABORT_GAME request with user1. It should return a SUCCESS response.
        //     */
        //    @Test
        //    void testAbortGameWithUser1() {
        //        // Test 22
        //        // Send an ABORT_GAME request with user1.
        //        // It should return a SUCCESS response.
        //        PairingResponse pairingResponse = sendAbortGameRequestWithUser("user1");
        //        assertNotNull(pairingResponse);
        //        assertEquals(ResponseStatus.SUCCESS, pairingResponse.getStatus());
        //    }
        //    /*
        ...
        //     */
        //    @Test
        //    void testUpdatePairingWithUser2AfterAbortGame() {
        //        // Send a UPDATE_PAIRING request with user2.
        ...
        //    }
        //}e with an accept invitation response from user3.
        PairingResponse pairingResponse = sendUpdatePairingRequestWithUser("user1");
        assertNotNull(pairingResponse);
        assertNotNull(pairingResponse.getInvitationResponse());
    }
